...
class SlotsControllerTest < ActionController::TestCase
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post :create, slot: { appointment: @slot.appointment, appointmenttype: @slot.appointmenttype }
    end
  ...
  test "should update slot" do
    patch :update, id: @slot, slot: { appointment: @slot.appointment, appointmenttype: @slot.appointmenttype }
    assert_redirected_to slot_path(assigns(:slot))
  end
